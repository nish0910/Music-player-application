...
public class MusicPlayerActivity extends AppCompatActivity {
    ...
    MediaPlayer mediaPlayer = MyMediaPlayer.getInstances();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        musicIcon=findViewById(R.id.play);
        ...
        MusicPlayerActivity.this.runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (mediaPlayer != null) {
                    ...
                    currentTimeTv.setText(convertoMMS(mediaPlayer.getCurrentPosition() + ""));
    ...
    void setResourcesWithMusic(){
        ...
        TotalTimeTv.setText(convertoMMS(currentSong.getDuration()));
